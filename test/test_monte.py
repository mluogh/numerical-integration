...
class TestSampling(unittest.TestCase):
    ...
    def test_simple_fn(self):
        np.random.seed(0)
        n = 100000
        val = monte._hypercube_sample(lambda x: x, [0], [1], n=n)
        val /= n
    ...
    def test_simple_fn_improper(self):
        ...
        n = 100000
        val = monte._hypercube_sample(lambda x: x, [1], [0], n=n)
        val /= n
...
class TestIntegration(unittest.TestCase):
    ...
    def test_single_dimension(self):
        ...
        actual = 2/3
        val = monte.integrate_hypercube(lambda x: x[0] * x[0], [(-1, 1)], n=1000000)
    ...
    def test_multiple_dimensions(self):
        ...
        # x + y^2 + x + y
        actual = 2425 / 6
        val = monte.integrate_hypercube(lambda x: x[0] * x[1] * x[1] + x[0] + x[1], [(-2, 3), (2, 7)], n=n)
